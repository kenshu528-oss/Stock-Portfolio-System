...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: '2026-01-21',
    type: 'hotfix',
    title: '修復GitHub Pages環境API配置問題',
    description: '修復GitHub Pages環境下API配置錯誤，正確使用Netlify Functions作為代理，徹底解決CORS問題。',
    changes: [
      '修復 GitHub Pages 環境下 API 基礎 URL 配置',
      '正確使用 Netlify Functions 作為 API 代理',
      '修復股息 API 端點格式（查詢參數而非路徑參數）',
      '確保所有 API 調用都通過代理，避免 CORS 限制',
      '完善錯誤處理和日誌記錄'
    ]
  },
  {
    ...
    date: '2026-01-21',
    type: 'hotfix',
    title: '修復除權息和健康檢查CORS問題',
    description: '修復GitHub Pages環境下除權息資料獲取失敗和Yahoo Finance健康檢查CORS錯誤。添加FinMind API股息資料獲取方法，確保所有API調用都能在雲端環境正常運作。',
    changes: [
      '添加 FinMind API 股息資料獲取方法 (getDividendData)',
      '修復 GitHub Pages 環境下除權息資料獲取失敗',
      '修復 Yahoo Finance 健康檢查的 CORS 錯誤',
      '優化 GitHub Pages 環境的 API 調用策略',
      '確保所有 API 調用都能在雲端環境正常運作'
    ]
  },
  {
    version: '1.0.2.0242',
