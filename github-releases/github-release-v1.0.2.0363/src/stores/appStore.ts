          ...
          try {
            for (let i = 0; i < stocks.length; i++) {
              ...
              try {
                ...
                try {
                  ...
                  if (shouldUseBackendProxy()) {
                    ...
                    priceData = await StockDataMerger.getStockPrice(stock.symbol, {
                      preferredSource: DataSourcePriority.VERCEL_EDGE,
              ...
              if (i < stocks.length - 1) {
                await new Promise(resolve => setTimeout(resolve, 500)); // 增加間隔避免 API 限制
              }
            }
