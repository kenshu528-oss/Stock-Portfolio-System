...
function getBackupDividendData(symbol) {
  const backupData = {
    '00937B': [
      { exDate: '2025-12-16', amount: 0.072, type: 'cash', year: 2025, quarter: 12 },
      { exDate: '2025-11-18', amount: 0.072, type: 'cash', year: 2025, quarter: 11 },
      { exDate: '2025-10-16', amount: 0.072, type: 'cash', year: 2025, quarter: 10 },
      { exDate: '2025-09-18', amount: 0.072, type: 'cash', year: 2025, quarter: 9 },
      { exDate: '2025-08-16', amount: 0.072, type: 'cash', year: 2025, quarter: 8 },
      { exDate: '2025-07-18', amount: 0.072, type: 'cash', year: 2025, quarter: 7 },
      { exDate: '2025-06-16', amount: 0.072, type: 'cash', year: 2025, quarter: 6 },
      { exDate: '2025-05-18', amount: 0.072, type: 'cash', year: 2025, quarter: 5 },
      { exDate: '2025-04-16', amount: 0.072, type: 'cash', year: 2025, quarter: 4 },
      { exDate: '2025-03-18', amount: 0.072, type: 'cash', year: 2025, quarter: 3 },
      { exDate: '2025-02-16', amount: 0.072, type: 'cash', year: 2025, quarter: 2 },
      { exDate: '2025-01-18', amount: 0.072, type: 'cash', year: 2025, quarter: 1 }
    ],
    '00679B': [
      { exDate: '2025-12-15', amount: 0.08, type: 'cash', year: 2025, quarter: 12 },
      { exDate: '2025-11-15', amount: 0.08, type: 'cash', year: 2025, quarter: 11 },
      { exDate: '2025-10-15', amount: 0.08, type: 'cash', year: 2025, quarter: 10 },
      { exDate: '2025-09-15', amount: 0.08, type: 'cash', year: 2025, quarter: 9 },
      { exDate: '2025-08-15', amount: 0.08, type: 'cash', year: 2025, quarter: 8 },
      { exDate: '2025-07-15', amount: 0.08, type: 'cash', year: 2025, quarter: 7 },
      { exDate: '2025-06-15', amount: 0.08, type: 'cash', year: 2025, quarter: 6 },
      { exDate: '2025-05-15', amount: 0.08, type: 'cash', year: 2025, quarter: 5 },
      { exDate: '2025-04-15', amount: 0.08, type: 'cash', year: 2025, quarter: 4 },
      { exDate: '2025-03-15', amount: 0.08, type: 'cash', year: 2025, quarter: 3 },
      { exDate: '2025-02-15', amount: 0.08, type: 'cash', year: 2025, quarter: 2 },
      { exDate: '2025-01-15', amount: 0.08, type: 'cash', year: 2025, quarter: 1 }
    ]
  };
  
  const data = backupData[symbol];
  if (data) {
    console.log(`使用備用股息資料 ${symbol}: ${data.length} 筆記錄`);
    return {
      symbol,
      dividends: data
    };
...
// API路由：獲取股息資料 - 使用Yahoo Finance API
app.get('/api/dividend/:symbol', async (req, res) => {
  try {
    ...
    // 對於ETF，優先嘗試Yahoo Finance（可能有更好的ETF支援）
    let dividendData = null;
    
    if (upperSymbol.match(/^00\d{2,3}[A-Z]?$/)) {
      console.log(`${upperSymbol} 是ETF，優先嘗試Yahoo Finance`);
      dividendData = await getYahooDividendData(upperSymbol);
      
      // 如果Yahoo Finance沒有資料，再嘗試GoodInfo
