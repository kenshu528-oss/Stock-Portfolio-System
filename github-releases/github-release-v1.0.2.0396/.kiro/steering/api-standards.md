...
| 市場類型 | 代碼範圍 | Yahoo Finance 後綴 | 範例 | 完整代號 |
|---------|---------|-------------------|------|----------|
| 上市股票 | 1000-2999 | `.TW` | 台積電 (2330) | `2330.TW` |
| 上櫃股票 | 3000-8999 | `.TWO` | 元太 (8069) | `8069.TWO` |
| 興櫃股票 | 4000-4999 | `.TW` 或 `.TWO` | 達明 (4585) | `4585.TW` (最常用) |
| 一般 ETF | 00XXX | `.TWO` | 元大台灣50 (0050) | `0050.TWO` |
| 債券 ETF | 00XXXB | `.TWO` | 元大美債20年 (00679B) | `00679B.TWO` |

#### 特殊案例清單

| 股票代號 | 公司名稱 | 市場類型 | 應使用後綴 | 原因 |
|---------|---------|---------|-----------|------|
| 8112 | 至上 | 上櫃 | `.TW` | 雖在 8000 範圍但 Yahoo Finance 使用 .TW |
| 4585 | 達明 | 興櫃 | `.TW` | 興櫃股票，最常用 .TW |

#### FinMind API 使用規則

**FinMind 設計較為直覺，不需要任何英文後綴，直接使用數字代號即可**

| 市場類型 | 範例代號 | FinMind 使用方式 | 備註 |
|---------|---------|-----------------|------|
| 上市 | 2330 | `stock_id="2330"` | 直接傳入數字 |
| 上櫃 | 8069 | `stock_id="8069"` | 不分市場類型 |
| 興櫃 | 4585 | `stock_id="4585"` | 只要有掛牌都能抓 |
| ETF | 00940 | `stock_id="00940"` | 數字必須為字串格式 |
