...
export const AUTO_FILL_CONFIG = {
  ...
  DEV_TOKEN: (() => {
    // 嘗試從環境變數讀取，如果失敗則使用實際 token
    try {
      return import.meta.env?.VITE_DEV_TOKEN || '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';
    } catch (e) {
      // 如果 import.meta.env 不可用，直接返回實際 token
      return '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';
    }
  })(),
