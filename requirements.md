...
3. WHEN 使用者選擇刪除股票記錄 THEN 系統 SHALL 顯示確認對話框並在確認後移除該記錄
4. WHEN 使用者點擊股票記錄的持股數或成本價欄位 THEN 系統 SHALL 提供即時編輯功能
5. WHEN 使用者新增已存在的股票代碼至同一帳戶 THEN 系統 SHALL 詢問是否合併持股或建立獨立記錄
